...
postcode_avg_fuel_price <- rbind(calculate_avg_postcode_fuelprice(nsw, "U91", 30),
                                 calculate_avg_postcode_fuelprice(nt, "U91", 30),
                                 calculate_avg_postcode_fuelprice(qld, "U91", 30),
                                 calculate_avg_postcode_fuelprice(sa, "U91", 30),
                                 calculate_avg_postcode_fuelprice(tas, "U91", 30))
