...
nsw_address <- read_csv("fuel-prices/nsw_address.csv")

nt_address <- read_csv("fuel-prices/nt_address.csv")

qld_address <- read_csv("fuel-prices/qld_address.csv")

sa_address <- read_csv("fuel-prices/sa_address.csv")

tas_address <- read_csv("fuel-prices/tas_address.csv")

# wa_address <- read_csv("fuel-prices/wa_address.csv")
```
